(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      "home.step1.body":
        "Use a página Decodificador para inserir o reporte bruto exatamente como recebido.",
      "home.step2.title": "2. Confira as partes",
      "home.step2.body":
        "O sistema separa o código em grupos de vento, visibilidade, tempo, nuvens, temperatura e pressão.",
      "home.step3.title": "3. Leia a tradução",
      "home.step3.body":
        "Cada grupo recebe uma descrição em linguagem direta para estudo e consulta operacional.",
      "home.step4.title": "4. Revise alertas",
      "home.step4.body":
        "Tokens desconhecidos ou suspeitos são destacados para revisão manual do reporte.",
      "home.recommended.title": "Uso recomendado",
      "home.recommended.body":
        "Siga o fluxo ideal do sistema em três passos e use cada página no seu propósito:",
      ...
      "about.hero.subtitle":
        "Conheça a estrutura dos reportes meteorológicos aeronáuticos",
      "about.hero.body":
        "Use esta página para compreender os principais grupos de informação presentes em um METAR, como vento, visibilidade, tempo significativo, nuvens, temperatura e pressão. Após entender a estrutura, você estará preparado para usar as ferramentas de consulta e decodificação.",
      "about.quick.eyebrow": "REFERÊNCIA RÁPIDA",
      "about.quick.heading": "O que é METAR?",
      "about.quick.body":
        "METAR é um reporte meteorológico padronizado usado na aviação para informar condições observadas em aeródromos. Ele agrupa dados como vento, visibilidade, tempo presente, nuvens, temperatura, ponto de orvalho e pressão.",
      "about.tree.eyebrow": "ÁRVORE DE CONHECIMENTO METAR",
      "about.tree.heading":
        "Entenda cada fatia do reporte meteorológico aeronáutico com este exemplo a seguir:",
      ...
      "about.knowledge.METAR.explanation":
        "Relatório meteorológico regular de aeródromo.",
      "about.knowledge.METAR.note":
        "Indica que o reporte segue o formato padronizado METAR.",
      "about.knowledge.SBGR.category": "Identificador da estação",
      "about.knowledge.SBGR.explanation":
        "Código ICAO do Aeroporto de Guarulhos.",
      "about.knowledge.SBGR.note":
        "O primeiro identificador de quatro letras aponta a estação meteorológica ou aeródromo.",
      "about.knowledge.252100Z.category": "Data e hora do reporte",
      "about.knowledge.252100Z.explanation": "Dia 25, às 21:00 UTC.",
      "about.knowledge.252100Z.note":
        "O sufixo Z indica horário Zulu, equivalente ao UTC.",
      "about.knowledge.09003KT.category": "Vento",
      "about.knowledge.09003KT.explanation":
        "Vento vindo de 090° com velocidade de 3 nós.",
      "about.knowledge.09003KT.note":
        "Os três primeiros dígitos indicam a direção e os seguintes indicam a velocidade.",
      "about.knowledge.0500.category": "Visibilidade predominante",
      "about.knowledge.0500.explanation":
        "Visibilidade horizontal de 500 metros.",
      "about.knowledge.0500.note":
        "Valores de quatro dígitos, em METAR internacional, normalmente indicam metros.",
      "about.knowledge.0200N.category": "Visibilidade direcional",
      "about.knowledge.0200N.explanation":
        "Visibilidade de 200 metros na direção norte.",
      "about.knowledge.0200N.note":
        "A letra final informa o setor direcional associado à visibilidade.",
      "about.knowledge.FG.category": "Tempo presente",
      "about.knowledge.FG.explanation": "Nevoeiro.",
      "about.knowledge.FG.note":
        "FG identifica fog, usado quando há redução importante de visibilidade.",
      "about.knowledge.VV002.category": "Visibilidade vertical",
      "about.knowledge.VV002.explanation": "Visibilidade vertical de 200 pés.",
      "about.knowledge.VV002.note":
        "VV seguido de três dígitos representa centenas de pés.",
      "about.knowledge.12/12.category": "Temperatura / ponto de orvalho",
      "about.knowledge.12/12.explanation":
        "Temperatura de 12°C e ponto de orvalho de 12°C.",
      "about.knowledge.12/12.note":
        "Quando os valores se igualam, o ar está saturado ou muito próximo disso.",
      ...
      "airports.hero.body":
        "Digite nome, cidade, país, código ICAO ou IATA para encontrar o aeródromo desejado. O código ICAO é o identificador usado nas consultas meteorológicas. Localize o código certo antes de consultar o METAR.",
      "airports.search.title": "Pesquisar",
      "airports.search.label": "Termo de busca",
      "airports.search.placeholder":
        "Digite o nome do aeroporto, cidade, país, IATA ou código ICAO",
      "airports.search.button": "Buscar aeródromo",
      "airports.panel.eyebrow": "Consulta de aeródromos",
      "airports.panel.heading":
        "Localize o código ICAO de aeroportos e aeródromos",
      "airports.panel.body":
        "Use esta seção para encontrar o código ICAO necessário para futuras consultas METAR no DecMET. A base de aeródromos está estruturada a partir dos dados da OurAirports, OpenFlight e ANAC.",
      "airports.state.loading": "Buscando aeródromos...",
      "airports.state.empty": "Digite um termo para iniciar a busca.",
      "airports.state.noResults":
        "Nenhum aeródromo encontrado para essa pesquisa.",
      "airports.state.error":
        "Não foi possível consultar a base de aeródromos no momento.",
      ...
      "airports.copy.button": "Copiar ICAO",
      "airports.copy.copied": "Copiado",
      "airports.copy.aria": "Copiar código ICAO",
      ...
      "metar.hero.subtitle": "Entrada operacional preparada para integração.",
      "metar.hero.body":
        "Informe um código ICAO para consultar o METAR mais recente.",
      "metar.query.eyebrow": "Consulta operacional",
      "metar.query.heading": "Consulta METAR em tempo real",
      "metar.query.body":
        "Digite o código ICAO de quatro letras do aeródromo selecionado. A consulta retorna o METAR bruto mais recente.",
      ...
      "metar.state.empty.body":
        "Informe um código ICAO para preparar a consulta METAR.",
      "metar.state.loading.label": "Consultando METAR",
      "metar.state.loading.body": "Buscando o METAR mais recente.",
      "metar.state.error.label": "Entrada inválida",
      "metar.state.result.label": "METAR recebido",
      "metar.state.result.body":
        "O METAR bruto foi retornado, e está pronto para cópia ou leitura manual.",
      "metar.result.rawTitle": "METAR bruto",
      "metar.result.copy": "Copiar METAR",
      "metar.result.empty": "Aguardando Consulta...",
      "metar.result.noaaTitle": "Dados estruturados via NOAA/REDEMET",
      ...
      "metar.result.defaultSource": "...",
      "metar.manual.title": "Decodificação manual",
      "metar.manual.body":
        "METAR recebido? Copie o código bruto e abra o Decodificador para interpretar a mensagem manualmente.",
      "metar.manual.link": "Abrir Decodificador",
      "metar.notes.title": "Notas operacionais",
      "metar.error.invalidIcao":
        "Digite exatamente quatro letras para o código ICAO.",
      "metar.error.noRecent":
      ...
      "metar.error.connection":
        "Não foi possível conectar-se com nosso Servidor. Verifique se o servidor está em execução.",
      "metar.error.noRaw":
        "O Servidor não retornou um METAR bruto para este código ICAO.",
      ...
      "decoder.hero.subtitle":
        "Cole um reporte METAR bruto e visualize sua interpretação",
      "decoder.hero.body":
        "Use esta página para transformar grupos meteorológicos em descrições legíveis, facilitando o estudo e a consulta rápida das condições reportadas. Cole o METAR exatamente como recebido, e o sistema separará os componentes técnicos em uma apresentação operacional.",
      ...
      "decoder.input.placeholder":
        "METAR SBGR 252100Z 09003KT 0500 0200N FG VV002 12/12 Q1016",
      ...
      "metar.dynamic.description":
        "Confira o METAR mais recente de {{icao}} ({{stationName}}): vento {{wind}}, visibilidade {{visibility}}, temperatura {{temp}}.",
      "airport.dynamic.title":
        "Aeródromo {{icao}} - {{name}} | Código ICAO e Informações",
      "airport.dynamic.description":
        "Informações completas do aeródromo {{name}} ({{icao}}): localização, coordenadas, altitude e tipo de operação.",

      "home.tools.title":
        "Ferramenta de aviação para METAR, ICAO e meteorologia aeronáutica",
      ...
      "about.practice.readByGroups.title":
        "Leia por grupos, não por palavras soltas",
      "about.practice.readByGroups.body":
        "Um METAR é organizado em blocos padronizados. Identifique primeiro a estação ICAO, depois data e hora, vento, visibilidade, fenômenos meteorológicos, nuvens, temperatura, ponto de orvalho e pressão.",
      "about.practice.observe.title":
        "Observe os elementos que afetam a operação",
      "about.practice.observe.body":
        "Vento forte ou com rajadas, visibilidade reduzida, nevoeiro, trovoada, teto baixo e variação de pressão são sinais importantes para a leitura aeronáutica do tempo observado.",
      ...
      "airports.howto.search.body":
        "A busca aceita diferentes termos para localizar aeroportos, helipontos e aeródromos. O código ICAO de quatro letras é o identificador usado para consultar METAR.",
      ...
      "decoder.howto.step3.body":
        "Use a tradução do METAR para leitura rápida, treinamento e conferência, todavia, visando uma análise mais acurada manualmente.",
    },
    "en-US": {
      ...
      "home.step1.body":
        "Use the Decoder page to enter the raw report exactly as received.",
      "home.step2.title": "2. Check the parts",
      "home.step2.body":
        "The system separates the code into wind, visibility, weather, cloud, temperature, and pressure groups.",
      "home.step3.title": "3. Read the translation",
      "home.step3.body":
        "Each group receives a plain-language description for study and operational reference.",
      "home.step4.title": "4. Review alerts",
      "home.step4.body":
        "Unknown or suspicious tokens are highlighted for manual review of the report.",
      "home.recommended.title": "Recommended use",
      "home.recommended.body":
        "Follow the ideal three-step system flow and use each page for its purpose:",
      "home.recommended.flow":
      ...
      "about.hero.subtitle":
        "Learn the structure of aeronautical weather reports",
      "about.hero.body":
        "Use this page to understand the main information groups in a METAR, such as wind, visibility, significant weather, clouds, temperature, and pressure. After learning the structure, you will be ready to use the lookup and decoding tools.",
      "about.quick.eyebrow": "QUICK REFERENCE",
      "about.quick.heading": "What is METAR?",
      "about.quick.body":
        "METAR is a standardized weather report used in aviation to communicate observed conditions at aerodromes. It groups data such as wind, visibility, present weather, clouds, temperature, dew point, and pressure.",
      "about.tree.eyebrow": "METAR KNOWLEDGE TREE",
      "about.tree.heading":
        "Understand each slice of the aeronautical weather report with this example:",
      ...
      "about.knowledge.METAR.explanation":
        "Regular aerodrome meteorological report.",
      "about.knowledge.METAR.note":
        "Indicates that the report follows the standardized METAR format.",
      "about.knowledge.SBGR.category": "Station identifier",
      "about.knowledge.SBGR.explanation": "ICAO code for Guarulhos Airport.",
      "about.knowledge.SBGR.note":
        "The first four-letter identifier points to the weather station or aerodrome.",
      "about.knowledge.252100Z.category": "Report date and time",
      "about.knowledge.252100Z.explanation": "Day 25 at 21:00 UTC.",
      "about.knowledge.252100Z.note":
        "The Z suffix indicates Zulu time, equivalent to UTC.",
      "about.knowledge.09003KT.category": "Wind",
      "about.knowledge.09003KT.explanation": "Wind from 090° at 3 knots.",
      "about.knowledge.09003KT.note":
        "The first three digits indicate direction and the following digits indicate speed.",
      "about.knowledge.0500.category": "Prevailing visibility",
      "about.knowledge.0500.explanation":
        "Horizontal visibility of 500 meters.",
      "about.knowledge.0500.note":
        "Four-digit values in international METAR usually indicate meters.",
      "about.knowledge.0200N.category": "Directional visibility",
      "about.knowledge.0200N.explanation":
        "Visibility of 200 meters toward the north.",
      "about.knowledge.0200N.note":
        "The final letter indicates the directional sector associated with visibility.",
      "about.knowledge.FG.category": "Present weather",
      "about.knowledge.FG.explanation": "Fog.",
      "about.knowledge.FG.note":
        "FG identifies fog, used when visibility is significantly reduced.",
      "about.knowledge.VV002.category": "Vertical visibility",
      "about.knowledge.VV002.explanation": "Vertical visibility of 200 feet.",
      "about.knowledge.VV002.note":
        "VV followed by three digits represents hundreds of feet.",
      "about.knowledge.12/12.category": "Temperature / dew point",
      "about.knowledge.12/12.explanation":
        "Temperature of 12°C and dew point of 12°C.",
      "about.knowledge.12/12.note":
        "When the values are equal, the air is saturated or very close to saturation.",
      ...
      "airports.hero.body":
        "Enter a name, city, country, ICAO code, or IATA code to find the desired aerodrome. The ICAO code is the identifier used in weather queries. Find the right code before checking the METAR.",
      "airports.search.title": "Search",
      "airports.search.label": "Search term",
      "airports.search.placeholder":
        "Enter airport name, city, country, IATA, or ICAO code",
      "airports.search.button": "Search aerodrome",
      "airports.panel.eyebrow": "Aerodrome lookup",
      "airports.panel.heading":
        "Find the ICAO code for airports and aerodromes",
      "airports.panel.body":
        "Use this section to find the ICAO code required for future METAR lookups in DecMET. The aerodrome database is structured from OurAirports, OpenFlight and ANAC data.",
      ...
      "airports.state.error":
        "Could not query the aerodrome database right now.",
      "airports.demo": "Demo",
      ...
      "airports.copy.button": "Copy ICAO",
      "airports.copy.copied": "Copied",
      "airports.copy.aria": "Copy ICAO code",
      "airports.label.iata": "IATA",
      ...
      "metar.query.body":
        "Enter the four-letter ICAO code for the selected aerodrome. The query returns the latest raw METAR.",
      ...
      "metar.state.empty.body":
        "Enter an ICAO code to prepare the METAR lookup.",
      "metar.state.loading.label": "Checking METAR",
      "metar.state.loading.body": "Looking for the most recent METAR.",
      "metar.state.error.label": "Invalid input",
      "metar.state.result.label": "METAR received",
      "metar.state.result.body":
        "The raw METAR was returned and is ready to copy or read manually.",
      "metar.result.rawTitle": "Raw METAR",
      "metar.result.copy": "Copy METAR",
      "metar.result.empty": "Waiting for Lookup...",
      "metar.result.noaaTitle": "NOAA/REDEMET structured data",
      ...
      "metar.manual.body":
        "METAR received? Copy the raw code and open the Decoder to interpret the message manually.",
      "metar.manual.link": "Open Decoder",
      "metar.notes.title": "Operational notes",
      "metar.error.invalidIcao":
        "Enter exactly four letters for the ICAO code.",
      "metar.error.noRecent": "No recent METAR was found for this ICAO code.",
      "metar.error.generic": "Could not query the METAR right now.",
      "metar.error.connection":
        "We were unable to connect to our server. Please check if the server is running.",
      "metar.error.noRaw":
        "The Server did not return a raw METAR for this ICAO code.",
      ...
      "decoder.hero.subtitle":
        "Paste a raw METAR report and view its interpretation",
      "decoder.hero.body":
        "Use this page to transform meteorological groups into readable descriptions, making it easier to study and quickly check reported conditions. Paste the METAR exactly as received, and the system will separate the technical components into an operational presentation.",
      ...
      "metar.dynamic.description":
        "Check the latest METAR for {{icao}} ({{stationName}}): wind {{wind}}, visibility {{visibility}}, temperature {{temp}}.",
      "airport.dynamic.title":
        "Aerodrome {{icao}} - {{name}} | ICAO Code and Information",
      "airport.dynamic.description":
        "Complete information for {{name}} ({{icao}}): location, coordinates, elevation and operation type.",
      "home.tools.title":
        "Aviation tool for METAR, ICAO and aeronautical weather",
      ...
      "about.practice.readByGroups.title":
        "Read by groups, not by isolated words",
      "about.practice.readByGroups.body":
        "A METAR is organized into standardized blocks. First identify the ICAO station, then date and time, wind, visibility, weather phenomena, clouds, temperature, dew point and pressure.",
      "about.practice.observe.title": "Observe elements that affect operations",
      "about.practice.observe.body":
        "Strong or gusty wind, reduced visibility, fog, thunderstorm, low ceiling and pressure changes are important signs for aeronautical weather reading.",
      ...
      "airports.howto.search.body":
        "The search accepts different terms to locate airports, heliports and aerodromes. The four-letter ICAO code is the identifier used for METAR queries.",
      ...
      "decoder.howto.step3.body":
        "Use the METAR translation for quick reading, training, and cross-checking, while simultaneously aiming for a more precise manual analysis.",
    },
  };
  ...
  function setLanguage(lang) {
    ...
    window.dispatchEvent(
      new CustomEvent("decmet:languagechange", { detail: { language } }),
    );
  }
  ...
  function translatePage(root = document) {
    ...
    if (
      ogDesc &&
      ogDesc.dataset.i18nOgDescription &&
      !window._dynamicDescriptionActive
    ) {
      ogDesc.content = t(ogDesc.dataset.i18nOgDescription);
    }

    // Removemos a classe de bloqueio para revelar o conteúdo traduzido
  ...
  // ========== NOVAS FUNÇÕES SEO ==========
  function setDynamicTitleAndDescription(
    titleKey,
    descriptionKey,
    variables = {},
  ) {
